# 한국어 공공금융 RFP 요구사항 품질 자동 평가
## 영문 NLP 도구(Paska)의 한국어 어댑테이션 및 도메인 특화 휴리스틱
...
### 7.6 영문 vs 한국어 Smell 분포 비교

| Smell | 영문 (D3) | 한국 자체 (D1) | 한국 정형 (D2) |
|---|---|---|---|
| Passive voice / 수동태 | **27.5%** | 8.0% | 10.0% |
| Non-atomic / 복합의무 | **13.8%** | 2.7% | 0.0% |
| Missing-quant / 정량부재 | 1.3% | 6.7% | 6.7% |
| 모호어 (한국 통합) | n/a | **30.7%** | **26.7%** |
| 주체모호 | n/a | **32.0%** | **26.7%** |
| 약한의무 (신규) | n/a | 0.0% | **30.0%** |
| 미정의 약어 (신규) | n/a | 1.3% | 3.3% |
